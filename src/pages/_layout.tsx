                    ...
                    <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-[rgb(var(--color-text-muted))]">SDK & iframe demo</p>
                            </div>
                        </div>
                    ...
                    {"error" in whoami ? (
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 border-t border-[rgb(var(--color-border))] pt-2 text-xs text-[rgb(var(--color-text-muted))]">
                            ...
                            <span title="Team name">
                                <strong className="text-[rgb(var(--color-text))]">Team:</strong> {whoami.teamName}
                            </span>
                            ...
                            <span title="Owner email">
                                <strong className="text-[rgb(var(--color-text))]">Owner:</strong> {whoami.ownerEmail}
                            </span>
